    ...
    <el-main>
      ...
      <div class="main">
        <div class="page-header">
          <h2 class="page-title">Account Appeals</h2>
          <p class="page-copy">
        ...
        <div class="search">
          ...
          >
            ...
            <el-table-column prop="shensu_user" label="Appeal Account" />
            <el-table-column prop="shensu_content" label="Appeal Content" />
            <el-table-column prop="shensu_jubao_id" label="Ban Reason">
              <template #default="scope">
                <el-button type="primary" link size="small" @click="tojubao(scope.row)">
                  View Ban Reason
                </el-button>
              </template>
            </el-table-column>
            ...
            <el-table-column label="Status" prop="jubao_state">
              <template #default="scope">
                <span v-if="scope.row.shensu_state == 0" style="color: #409eff">Unprocessed</span>
                <span v-if="scope.row.shensu_state == 1" style="color: #6cbb7a">Processed</span>
                <span v-if="scope.row.shensu_state == 2" style="color: #f60c6c">Flagged</span>
              </template>
            </el-table-column>
