      ...
      <div class="main">
        <div class="user-info clearfix">
          ...
          <ul class="first-userInfo">
            ...
            <li>
              Created At:
              <span>{{ formatDate(tableData.user_createtime) }}</span>
            </li>
          </ul>
          <ul>
            <li>
            ...
            <li>
              Role:
              <span v-if="tableData.username === 'admin'" style="margin-left: 20px">
                Super Admin
              </span>
              <span v-else style="margin-left: 20px">Normal Admin</span>
            </li>
            <li>
              Permissions:
              <span
                v-if="String(tableData.issh) === '1' && tableData.username !== 'admin'"
                style="margin-left: 20px"
              >
                Review Center
              </span>
              <span
                v-if="String(tableData.isyh) === '1' && tableData.username !== 'admin'"
                style="margin-left: 20px"
              >
                User Center
              </span>
              <span
                v-if="String(tableData.isgl) === '1' && tableData.username !== 'admin'"
                style="margin-left: 20px"
              >
                Platform Management
              </span>
              <span
                v-if="String(tableData.isfk) === '1' && tableData.username !== 'admin'"
                style="margin-left: 20px"
              >
                Feedback Center
              </span>
        ...
        <div class="renwu">
          ...
          <el-divider />
          <div v-if="String(uinfo?.jurisdiction?.issh) === '1' || uinfo?.username === 'admin'">
            <span>Review site content and user comments.</span>
            <el-divider />
          </div>
          <div v-if="String(uinfo?.jurisdiction?.isyh) === '1' || uinfo?.username === 'admin'">
            <span>Manage user verification and account status.</span>
            <el-divider />
          </div>
          <div v-if="String(uinfo?.jurisdiction?.isgl) === '1' || uinfo?.username === 'admin'">
            <span>Manage homepage carousel and module categories.</span>
            <el-divider />
          </div>
          <div v-if="String(uinfo?.jurisdiction?.isfk) === '1' || uinfo?.username === 'admin'">
            <span>Manage user feedback and violation reports.</span>
            <el-divider />
          </div>
          <div v-if="uinfo?.username === 'admin'">
            <span>Manage admin accounts and remove site content when needed.</span>
            <el-divider />
          </div>
