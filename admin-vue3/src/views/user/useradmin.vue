    ...
    <el-main>
      <div class="top">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>Admin User Management</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
        ...
        <section class="workspace-card">
          <div class="search workspace-filters">
            <el-form :inline="true" :model="filterForm" class="demo-form-inline">
              <el-form-item>
                <el-input v-model="filterForm.user" placeholder="Fuzzy search by account" />
              </el-form-item>
              <el-form-item>
                <el-select
          ...
          <el-dialog v-model="dialogFormVisibleadd" title="Add New Account" width="500px">
            <el-form>
              ...
              <el-form-item label="Confirm Password" label-width="100px">
                <el-input v-model="user.password1" type="password" autocomplete="off" />
              </el-form-item>
            </el-form>
            <template #footer>
              <div class="dialog-footer">
                <el-button @click="dialogFormVisibleadd = false">Cancel</el-button>
                <el-button type="primary" @click="registered">Confirm</el-button>
              </div>
            </template>
          </el-dialog>
          ...
          >
            ...
            <el-table-column prop="nickname" label="Review Center">
            ...
            <el-table-column prop="nickname" label="User Management">
              <template #default="scope">
                <el-switch
            ...
            <el-table-column prop="nickname" label="Site Management">
              <template #default="scope">
                <el-switch
            ...
            <el-table-column prop="nickname" label="Feedback Center">
              <template #default="scope">
                <el-switch
            ...
            <el-table-column prop="nickname" label="Account Status">
              <template #default="scope">
                <el-switch
...
<script setup>
  ...
  const registered = async () => {
    ...
    if (!pwdReg.test(user.password)) {
      ElMessage.error('Password must be 6-18 characters and start with a letter')
      return
    }
  ...
  const changestate = async row => {
    try {
      ...
      ElMessage.error(res.data?.state?.msg || 'Failed to update authorization')
    } catch {
  ...
  const change = async () => {
    try {
      ...
      const res = await axios.post('/admin/changepassword', toFormData(payload))
      if (res.data?.state?.type === 'SUCCESS') {
