    ...
    <el-main>
      ...
      >
        ...
        <span style="margin-left: 50px; color: red">
          Tip: Press Enter after editing to save. If image upload
          finishes and the corresponding title/link are filled, create
          or update will run automatically.
        </span>
      </div>
      <div
        v-for="(item, id) in carouselList"
        :key="id"
        class="main"
      ...
      >
        ...
        >
          <el-form-item label="Image">
            ...
            >
              <img
                v-if="item.carousel_img"
                :src="item.carousel_img"
                class="avatar"
              >
              <el-icon
                v-else
          ...
          <el-form-item label="Title">
            <el-input
              v-model="item.carousel_title"
              @keyup.enter="changecarousel(id)"
            />
          </el-form-item>
...
const uplogsuccess = (res, id) => {
	...
	if (item.carousel_url !== '' && item.carousel_title !== '') {
		changecarousel(id)
	}
}
