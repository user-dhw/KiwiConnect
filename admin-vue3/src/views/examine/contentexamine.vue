    ...
    <el-main>
      ...
      <div class="main">
        <section class="workspace-hero">
          <div>
            <p class="workspace-eyebrow">Review Workflow</p>
            <h1 class="workspace-title">Content Review</h1>
        ...
        >
          ...
          <el-form v-else-if="activeType === 'activity'">
            ...
            <el-form-item label="Content">
              <span
                v-html="currentContent.activity_content"
              />
            </el-form-item>
          </el-form>
          ...
          <el-form v-else-if="activeType === 'article'">
            ...
            <el-form-item label="Content">
              <span
                v-html="currentContent.article_content"
              />
            </el-form-item>
          </el-form>
          ...
          <el-form v-else-if="activeType === 'oldstuff'">
            <el-form-item label="Item">
              <img
                :src="currentContent.oldstuff_img"
                alt="Item image"
                width="300"
              >
            </el-form-item>
            ...
            <el-form-item label="Description">
              <span
                v-html="currentContent.oldstuff_content"
              />
            </el-form-item>
          </el-form>
        ...
        >
          ...
          >
            <template #default="scope">
              ...
              >{{ getStatusText(scope.row.ispublic) }}</span>
            </template>
          </el-table-column>
...
const del = async row => {
	...
	try {
		const res = await axios.post(
			'/admin/admindelete',
			toFormData({ id, type: activeType.value }),
		)
		if (res.data?.state?.type === 'SUCCESS') {
