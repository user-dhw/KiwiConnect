<template>
	<div class="edit-page">
		<h2>{{ isEdit ? 'Edit Activity' : 'Create Activity' }}</h2>
		<el-tabs type="border-card">
			<el-tab-pane label="Activity Editor">
				<el-form :model="form" label-width="140px">
					...
					<el-form-item>
						...
						>
						<el-button
							@click="router.push('/admin/createactivitylist')"
							>Cancel</el-button
						>
					</el-form-item>
				</el-form>
			...
			<el-tab-pane v-if="isEdit" label="Announcements">
				...
				>
					<el-form :model="announcement" label-width="90px">
						<el-form-item label="Title">
							<el-input
								v-model="announcement.announcement_name"
							/>
						</el-form-item>
			...
			<el-tab-pane v-else label="Announcements">
				Save this activity first, then you can publish announcements.
			</el-tab-pane>
...
const submit = async () => {
	if (
		...
		!form.value.activity_locale ||
		!form.value.activity_type ||
		!form.value.activity_lable
	) {
